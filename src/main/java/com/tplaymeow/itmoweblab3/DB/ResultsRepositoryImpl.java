...
public class ResultsRepositoryImpl implements ResultsRepository {
    ...
    @lombok.Generated
    private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(ResultsRepositoryImpl.class.getName());
    ...
    public void add(Result result) {
        String query = String.format("INSERT INTO %s(%s,%s,%s,%s,%s,%s) VALUES (?, ?, ?, ?, ?, ?)", Constants.TABLE_NAME, Constants.X_COLUMN, Constants.Y_COLUMN, Constants.R_COLUMN, Constants.SUCCESS_COLUMN, Constants.TIMESTAMP_DATE_COLUMN, Constants.TIMESTAMP_TIME_COLUMN);
        try (
    ...
    private static final class Constants {
        ...
        private static final String X_COLUMN = "x_coord";
        private static final String Y_COLUMN = "y_coord";
        private static final String R_COLUMN = "r_coord";
        private static final String SUCCESS_COLUMN = "success";
        private static final String TIMESTAMP_DATE_COLUMN = "timestamp_date";
        private static final String TIMESTAMP_TIME_COLUMN = "timestamp_time";
    }
}
